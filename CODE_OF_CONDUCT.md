...
reported privately to the [repository maintainers through GitHub](https://github.com/W-A-I-T/wait-local-agent),
for example by contacting [@nightcrawlerxme](https://github.com/nightcrawlerxme)
rather than posting sensitive details publicly. Do not use this route for
security vulnerabilities; follow [SECURITY.md](SECURITY.md) for security
reporting. All complaints will be reviewed and investigated promptly and
fairly.
