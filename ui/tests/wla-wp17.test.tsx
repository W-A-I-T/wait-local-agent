...
const dashboardState = vi.hoisted(() => ({ role: "admin" as "admin" | "viewer" }));
...
describe("wla-wp17 Launch Passport UI", () => {
  ...
  it("requires a preview before upload and turns a server refusal into clear guidance", async () => {
    ...
    expect(screen.getByText(/No source code, secret values, or connector credentials/)).toBeInTheDocument();
