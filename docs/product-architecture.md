...
- N-able N-sight connector with tenant-scoped device, failing-check, managed-antivirus threat, and mapped-device outage reads, patch inventory, plus approval-gated patch approval/reprocessing and allowlisted policy operations
