...
- N-able N-sight connector with tenant-scoped device, failing-check, and patch inventory
...
| N-able N-sight | Phase 4 | ✓ site/server/workstation, documented failing-check, and mapped-device patch inventory | Script/write parity remains unavailable | Public core |
