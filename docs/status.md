...
- N-able N-sight tenant-scoped site, server, and workstation inventory,
  ...
  threats, scan history, and quarantine records, plus approval-gated mapped-device scan start and
  cancellation,
