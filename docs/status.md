...
- N-able N-sight tenant-scoped site, server, and workstation inventory,
  ...
  products, threats, scan history, and quarantine records, plus approval-gated mapped-device scan start and
  cancellation,
