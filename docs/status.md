...
- N-able N-sight tenant-scoped site, server, and workstation inventory,
  ...
  products, threats, definition history, scan history, and quarantine records, plus approval-gated mapped-device scan start and
  cancellation,
