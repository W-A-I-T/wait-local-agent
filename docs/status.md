...
- Live RMM, Hudu, IT Glue, Confluence, or SharePoint write synchronization;
  ...
  session revocation, Intune managed-device retirement, mailbox-settings,
  message-move, and message-read-state updates remain
  unavailable.
