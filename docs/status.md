...
- N-able N-sight tenant-scoped site, server, and workstation inventory,
  documented per-device check, performance-history, and asset-details inventory, failing-check alerts, mapped-device outages, managed-antivirus
