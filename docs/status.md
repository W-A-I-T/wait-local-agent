...
- N-able N-sight tenant-scoped site, server, and workstation inventory,
  ...
  threats and scan history, Backup & Recovery session and 60-day backup-check history through the
