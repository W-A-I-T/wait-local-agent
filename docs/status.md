...
- Notion read-only mapped-page title search and bounded page-markdown retrieval
  through the common guarded HTTP boundary; database queries, comments, and
...
- Notion read-only mapped-page title search and page-markdown retrieval through
  the common guarded HTTP boundary; database queries, comments, and writes
  remain unavailable.
...
- A `/tools` API catalog that exposes existing smart-action schemas, including
  ...
  Notion mapped-page markdown, and SharePoint documentation search, and
...
| Notion read-only | Built, including mapped-page title search and bounded page-markdown retrieval |
...
| Notion connector | Read-only mapped-page search and bounded markdown retrieval built |
