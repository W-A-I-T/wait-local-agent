...
- The RMM boundary normalizes tenant-scoped `endpoint-agent` collector assets
  ...
  managed-antivirus product, threat, definition, update-check history, software inventory, and controlled scan records, mapped-device outage records, Backup & Recovery
