...
| [#257](https://github.com/W-A-I-T/wait-local-agent/issues/257) | F. Enterprise Readiness | Keep open; exercise routes, controls, state matrix, responsive behavior, and recovery in a real browser. | Chromium/browser evidence is not yet available in the current environment. |
