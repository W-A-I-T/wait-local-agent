...
| Execution step logs + audit | Workflow status, connector execution history, immutable audit events, JSON/CSV export, grouped agent tool-step traces, and cancellation status are shipped. | Add richer trigger context and failure/retry detail as new execution modes land. |
