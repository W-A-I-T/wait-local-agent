...
| PSA connectors | HaloPSA read paths and approval-gated writes plus read-only Autotask, ConnectWise, and Syncro ticket/company inventory are shipped. ServiceNow is not shipped. | Prioritize additional PSA connectors by operator demand and safe write coverage. |
